...
function colorPicker.create(id, start, title)
  ...
  cp.gui.window = guiCreateWindow((sw-cp.gui.width)/2, (sh-cp.gui.height)/2, cp.gui.width, cp.gui.height, tostring(title or "COLORPICKER"), false,"nocross")
  cp.gui.svmap = guiCreateStaticImage(16, 32, 256, 256, "Files/Images/Colorpicker/blank.png", false, cp.gui.window)
  cp.gui.hbar = guiCreateStaticImage(288, 32, 32, 256, "Files/Images/Colorpicker/blank.png", false, cp.gui.window)
  cp.gui.blank = guiCreateStaticImage(336, 32, 64, 64, "Files/Images/Colorpicker/blank.png", false, cp.gui.window)
  ...
  cp.gui.okb = guiCreateButton(336, 235, 64, 24, "Kaufen", false, cp.gui.window)
  cp.gui.closeb = guiCreateButton(336, 265, 64, 24, "Zurück", false, cp.gui.window)
...
function colorPicker:render()
  ...
  dxDrawImage(x+16, y+32, 256, 256, "Files/Images/Colorpicker/sv.png", 0, 0, 0, self.color.white, self.gui.focus)
  dxDrawImage(x+288, y+32, 32, 256, "Files/Images/Colorpicker/h.png", 0, 0, 0, self.color.white, self.gui.focus)
  dxDrawImageSection(x+8+math.floor(256*self.color.s), y+24+(256-math.floor(256*self.color.v)), 16, 16, 0, 0, 16, 16, "Files/Images/Colorpicker/cursor.png", 0, 0, 0, self.color.white, self.gui.focus)
  dxDrawImageSection(x+280, y+24+(256-math.floor(256*self.color.h)), 48, 16, 16, 0, 48, 16, "Files/Images/Colorpicker/cursor.png", 0, 0, 0, self.color.huecurrent, self.gui.focus)
...
function colorPicker:updateColor()
  ...
  setVehicleColor(getPedOccupiedVehicle(localPlayer),tostring(self.color.r),tostring(self.color.g),tostring(self.color.b))
end
...
function colorPicker:pickColor()
  ...
  triggerServerEvent("Tuningsystem.buyColor",localPlayer,self.color.r,self.color.g,self.color.b)
end
...
function colorPicker:destroy()
  ...
  if(isElement(self.gui.window))then destroyElement(self.gui.window)end
  if(pickerTable[self.id])then pickerTable[self.id] = nil end
