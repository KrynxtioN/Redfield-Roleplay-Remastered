...
function guiCreateNewWindow(x,y,w,h,text,relative,nocross)
	...
	if(not(nocross))then
		close = guiCreateStaticImage(3,3,15,15,"Files/Images/Kreuz.png",relative,window)
...
function guiCreateNewButton(x,y,w,h,text,relative,parent)
	local button = guiCreateStaticImage(x,y,w,h,"Files/Images/Button1.png",relative,parent)
